...
function createComment(url, request) {
  ...
  if (requestComment && requestComment.username && requestComment.body && request.body.comment &&
...
function updateComment(url, request) {
  ...
  if (!id || !requestComment) {
    ...
    requestComment.body=savedComment.body; //this I need to think about it
...
function deleteComment(url, request) {
  ...
  if (savedComment) {
    ...
    /*savedComment.articleIds.forEach(articleId => {
